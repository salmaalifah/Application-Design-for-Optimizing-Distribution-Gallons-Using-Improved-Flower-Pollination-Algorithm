            ...
            <div class="col-12">
                <div class="d-flex flex-fill">
                    <div class="btn-group d-flex flex-fill" role="group" aria-label="Button group with nested dropdown">
                        ...
                        <div class="btn-group flex-md-fill" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-info text-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" style="padding:10px;">Warehouse</button>
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                            <li><a class="dropdown-item" href="#">Informasi</a></li>
                            <li><a class="dropdown-item" href="update-warehouse">Update</a></li>
                            </ul>
                        </div>
        ...
        <div class="container-fluid" style="margin-top:20px;">
            <div class="row" style="min-height:100vh;">
                <div class="col-4" style="border-right:1px solid#000;">
                    ...
                    <div id="information" style="padding-left:20px;">
                        <?php include("../function/warehouse_info.php");?>
                    </div>
                    <a href="update-warehouse" class="btn btn-primary d-block">Update</a>
                </div>
                <div class="col-8">
